...
class Settings(BaseSettings):
  PROJECT_NAME: str = "InsightFuel AI Recommendation Engine"
  ...
  FEATURE_INTEL_URL: str = os.getenv("FEATURE_INTEL_URL", "http://localhost:3005")
  PRODUCT_HEALTH_URL: str = os.getenv("PRODUCT_HEALTH_URL", "http://localhost:3006")
