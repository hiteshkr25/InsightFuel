...
RECOMMENDATIONS_GENERATED = Counter(
  ...
  "Total number of recommendations generated by the AI Engine",
  ["project_id", "category", "severity"]
)
ACTIVE_RECOMMENDATIONS = Gauge(
  "ai_recommendations_active",
  "Number of currently active recommendations",
  ["project_id"]
)
COMPUTE_DURATION = Histogram(
  "ai_recommendation_computation_seconds",
  "Duration of the recommendation generation pipeline"
)
...
def setup_telemetry(app: FastAPI) -> None:
  ...
  root_logger = logging.getLogger("insightfuel.ai-engine")
