...
async def validate_jwt_and_project_access(
  ...
  try:
    ...
    # Tenant Isolation: Check organization has access to the project
  ...
  try:
    ...
    if count > 100:
      raise HTTPException(
        ...
        detail="Rate limit exceeded. Query API throttled."
      )
  except Exception as e:
    if isinstance(e, HTTPException):
      raise e
    logger.error(f"Rate limiter warning: {e}")
