...
# Metrics for jobs execution monitoring
COMPLETED_JOBS = Counter(
  "completed_jobs_total", 
  "Completed analytical job runs", 
  ["job_name", "status"]
)
JOB_DURATION = Histogram(
  "job_duration_seconds", 
  "Analytical calculation execution duration",
  ["job_name"]
)
...
def setup_telemetry(app: FastAPI) -> None:
  ...
  root_logger = logging.getLogger("insightfuel.analytics")
