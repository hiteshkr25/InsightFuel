...
class BackfillRequest(BaseModel):
  metric_name: str = Field(..., description="Name of the metric to backfill, e.g. session_analytics, user_analytics, retention_analytics, funnel_analytics, path_analytics, feature_analytics")
  start_date: str = Field(..., description="ISO 8601 Start Date string, e.g. 2026-07-01")
  end_date: str = Field(..., description="ISO 8601 End Date string, e.g. 2026-07-07")
