...
app = FastAPI(
  ...
  description="InsightFuel Product Health Processing Engine",
  version="1.0.0",
...
# Include v1 routers
app.include_router(health_router, prefix=settings.API_V1_STR, tags=["Product Health"])
