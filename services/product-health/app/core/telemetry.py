...
# Metrics for Product Health computations
PRODUCT_HEALTH_SCORE = Gauge(
  "product_health_score_ratio", 
  "Calculated platform overall health score", 
  ["project_id"]
)
HEALTH_COMPUTE_DURATION = Histogram(
  "product_health_computation_seconds", 
  "Duration of overall health metrics calculations"
)
...
def setup_telemetry(app: FastAPI) -> None:
  ...
  root_logger = logging.getLogger("insightfuel.product-health")
